...
Recommended fact table: `FactProfitability` from `analytics.vw_OrderProfitability`.
...
All three relationships are 1:* and single direction. Keep raw Returns and Shipping out of the main model unless a separate detail model is deliberately introduced.
...
- Whole number: orders, customers and returned orders.

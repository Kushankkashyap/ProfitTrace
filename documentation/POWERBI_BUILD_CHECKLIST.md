...
Use one-to-many, single-direction relationships from dimensions to fact.
...
- Profit leakage waterfall: Gross Revenue → Discount Value → Refund Value → Product Cost → Shipping Cost → Gross Profit
